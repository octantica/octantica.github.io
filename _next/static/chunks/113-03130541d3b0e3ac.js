        ...
        7533: function(e, t, n) {
            ...
            function U(e, t = 30, {
                ...
                let l = (0, r.useRef)(null),
                    ...
                    s = j(e);
                return (0, r.useEffect)((() => {
                    !a || l.current || (l.current = null == s ? void 0 : s.activeElement)
                }), [a, s]), (0, r.useEffect)((() => {
                    if (a) return () => {
                        L(l.current), l.current = null
                    }
                }), [a]), (0, r.useEffect)((() => {
                    if (!c) return;
                    let t = e.current;
                    ...
                    } else if (t.contains(r)) return void(i.current = r);
                    null != n && n.current ? L(n.current) : M(t, T.First) === D.Error && console.warn("There are no focusable elements inside the <FocusTrap />"), i.current = null == s ? void 0 : s.activeElement
                }), [e, n, c, s]), I(null == s ? void 0 : s.defaultView, "keydown", (n => {
                    !(4 & t) || !e.current || n.key === h.Tab && (n.preventDefault(), M(e.current, (n.shiftKey ? T.Previous : T.Next) | T.WrapAround) === D.Success && (i.current = null == s ? void 0 : s.activeElement))
                ...
                z = f((function(e, t) {
                    ...
                    return b((() => {
                        if (u && c) return u.appendChild(c), () => {
                            var e;
                            !u || !c || (u.removeChild(c), u.childNodes.length <= 0 && (null == (e = u.parentElement) || e.removeChild(u)))
                        }
            ...
            let be = i.RenderStrategy | i.Static,
                Ee = f((function(e, t) {
                    ...
                    (function(e, t = !0) {
                        ...
                        return n.style.overflow = "hidden", n.style.paddingRight = `${i}px`, () => {
                            n.style.overflow = o, n.style.paddingRight = l
                        }
                    }), [S, L]), (0, r.useEffect)((() => {
